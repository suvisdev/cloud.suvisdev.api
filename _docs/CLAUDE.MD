...
| 앱 | 역할 | 참조 |
|----|------|------|
| `titanic/` | CSV 업로드(James)·조회(Walter)·선장채팅(Smith) — **헥사고날 기준선** | `titanic/_docs/CLAUDE.md` |
| `mova/` | 영화·채팅·랭킹·리뷰 등 도메인 API | `mova/_docs/CLAUDE.md` |
| `viewer/` | 인증(`groups`, `admins`, `users`) — login/signup | `viewer/_docs/CLAUDE.md` |
| `friday13th/` | 개발 중 (스켈레톤 — main.py 미등록) | — |
| `imitation_game/` | 개발 중 (스켈레톤 — main.py 미등록) | — |
| `inception/` | 개발 중 (스켈레톤 — main.py 미등록) | — |
| `social_network/` | 개발 중 (스켈레톤 — main.py 미등록) | — |
