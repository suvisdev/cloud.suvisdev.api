...
| 순서 | 문서 | 용도 |
|------|------|------|
| 1 | **본 파일** (`suvisdev/CLAUDE.md`) | 아키텍처·레이어·SOLID·패턴 |
| 2 | [[entity-rules]] | PK `id` int 자동증감 |
| 3 | [[MOVA_ERD]] | Mova 테이블 관계 (해당 시) |
| 4 | [[titanic/_docs/CLAUDE]] | Titanic 기준선 세부 |
