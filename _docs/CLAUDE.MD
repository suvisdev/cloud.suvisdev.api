...
> **구조:** **모듈러 모놀리식(Modular Monolith)** — `star_craft`가 Hub, 나머지 앱이 Spoke.  
...
| 앱 | 역할 | 토폴로지 | 참조 |
|----|------|----------|------|
| `star_craft/` | **Hub** — 공통 이벤트 버스·온톨로지·하네스 평가 엔진 | ⭐ Hub | — |
