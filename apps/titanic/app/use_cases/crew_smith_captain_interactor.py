...
from suvisdev.apps.titanic.dependencies.passenger_jack_trainer_provider import get_jack_trainer
from suvisdev.apps.titanic.dependencies.passenger_rose_model_provider import get_rose_model
